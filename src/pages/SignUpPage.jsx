        ...
        <div className='w-full max-w-md space-y-8'>
            ...
            <div className='text-center  mb-8'>
                 <div className='flex flex-col items-center gap-2 group'>
                    <div
                       className='size-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bgprimary/20 transition-colors'
                    >
                        <MessageSquare className='size-5 text-primary group-hover:text-primary/80' />
                    </div>
